...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        self.params['W1'] = np.random.normal(0, weight_scale, size=(input_dim, hidden_dim)) #(D,H)
        self.params['b1'] = np.zeros(hidden_dim)
        self.params['W2'] = np.random.normal(0, weight_scale, size=(hidden_dim, num_classes)) #(H,C)
